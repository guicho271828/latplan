select generators.name  as domain,
       ...
       kltune."z1z2.compiled_action.train" as "$A_2$"
  from generators
         join (
           select generator, min("metrics.test.elbo") as elbo, "z1z2.xor.train", "action.true_num_actions.train", "z1z2.compiled_action.train", N
             from ama3
