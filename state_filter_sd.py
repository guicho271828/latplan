...
import config
import numpy as np
from model import StateDiscriminator, ConvolutionalGumbelAE2
...
def main():
    ...
    sd = StateDiscriminator("{}/_sd".format(directory)).load()
...
Apply StateDiscriminator to the states generated by EB-discriminator (generated_states.csv).
