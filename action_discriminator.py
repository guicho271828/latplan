...
def prepare_aae_PU4(known_transisitons):
    ...
    if len(known_transisitons) > 100:
        fake_transitions = fake_transitions[:len(known_transisitons)] # undersample
    
    print("valid:",len(known_transisitons),"mixed:",len(fake_transitions),)
    ...
    known_pre = known_transisitons[:, :N]
