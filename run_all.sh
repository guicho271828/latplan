...
parallel -j $jobs --eta --timeout 90 --joblog problem-instances/latplan.puzzles.puzzle_mnist.log  \
         "./trivial-planner.py samples/{1} {2} {3} > {2}/{1}_{3}.log" \
         ::: puzzle_mnist_3_3_36_20000_conv \
         ::: problem-instances/latplan.puzzles.puzzle_mnist/* \
         ::: Astar

parallel -j $jobs --eta --timeout 90 --joblog problem-instances/latplan.puzzles.puzzle_mandrill.log   \
         "./trivial-planner.py samples/{1} {2} {3} > {2}/{1}_{3}.log" \
...
parallel -j $jobs --eta --timeout 90 --joblog problem-instances/latplan.puzzles.puzzle_spider.log   \
         "./trivial-planner.py samples/{1} {2} {3} > {2}/{1}_{3}.log" \
...
parallel -j $jobs --eta --timeout 90 --joblog problem-instances/latplan.puzzles.hanoi.log   \
         "./trivial-planner.py samples/{1} {2} {3} > {2}/{1}_{3}.log" \
...
parallel -j $jobs --eta --timeout 90 --joblog problem-instances/latplan.puzzles.lightsout_digital.log   \
         "./trivial-planner.py samples/{1} {2} {3} > {2}/{1}_{3}.log" \
...
parallel -j $jobs --eta --timeout 90 --joblog problem-instances/latplan.puzzles.lightsout_twisted.log   \
         "./trivial-planner.py samples/{1} {2} {3} > {2}/{1}_{3}.log" \
