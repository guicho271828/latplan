nohup ./plan.py blind 'run_hanoi     ( "samples/hanoi_fc2"               ,"fc2", import_module("puzzles.hanoi")             )'   &> blind-hanoi     &
...
nohup ./plan.py pdb   'run_hanoi     ( "samples/hanoi_fc2"               ,"fc2", import_module("puzzles.hanoi")             )'   &> pdb-hanoi     &
